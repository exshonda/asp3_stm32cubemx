...
/*
 *  kernel.hのターゲット依存部（NUCLEO-C562RE用）
 *
 ...
 *  割込み数
 *
 *  STM32C562 の IRQn_Type の最大値は 81（LPDMA2_CH3_IRQn）．
 *  stm32c5xx_dfp/2.1.0/Include/stm32c562xx.h で確認．
 *  ベクタテーブルの整列（VTOR 要件）はこの値から target_kernel.py が
 *  自動計算する（98エントリ×4=392 → 512バイト境界）．
 */
#define TMAX_INTNO (81 + 16)
